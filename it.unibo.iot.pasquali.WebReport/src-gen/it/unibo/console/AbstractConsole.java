		...
		*/
	    ...
	    nPlanIter++;
	    		...
	    		if( currentEvent.getEventId().equals("update") ){
	    		 		String parg="updateMapAndReplan(NEWELEMENT,POS)";
	    		 		parg = updateVars(null, Term.createTerm("update(POS,NEWELEMENT)"), Term.createTerm("update(POS,NEWELEMENT)"), 
	    		 			    		  					Term.createTerm(currentEvent.getMsg()), parg);
	    		 			if( parg != null ) {
