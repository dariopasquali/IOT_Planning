%==============================================
% WorldTheory.pl for actor simulator
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusimulator).	%%old version (deprecated)
actorobj(qatusimulator).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor simulator
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of simulator" ). 
...
%-------------------------------------------------
%  User static rules about simulator
%------------------------------------------------- 
/*
------------------------------------------------------------------------
