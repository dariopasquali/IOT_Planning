...
private it.unibo.qactor.robot.RobotActor robot; 
	...
	public void configure() {
		...
		it.unibo.iot.executors.baseRobot.IBaseRobot baseRobot = 
				it.unibo.qactor.robot.RobotSysKb.setRobotBase(this,  "mymock" );
...
*/
	public static void main(String[] args) throws Exception{
		IOutputEnvView outEnvView = SituatedSysKb.standardOutEnvView;
 		InputStream sysKbStream    = //MainCtxRobot.class.getResourceAsStream("exploreandgo.pl");
 			new java.io.FileInputStream("./srcMore/it/unibo/ctxRobot/exploreandgo.pl");
