...
public class MqttUtils /*implements MqttCallback*/{
	...
	public MqttUtils(){
 	...
 	public String connect(String brokerAddr, String topic ) throws MqttException{

 		return connect(null, brokerAddr, topic);
	}
	...
	public void publish(QActor actor, String topic, String msg, boolean retain) throws MqttException{
	...
	public void subscribe(String topic, MqttCallback callback) throws Exception {
		subscribe(null, topic, callback);
	}
	
	public void subscribe(QActor actor, String topic, MqttCallback callback) throws Exception {
		try
		{
			this.actor = actor;
