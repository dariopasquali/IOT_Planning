...
//		String filename = loadDialog.getDirectory()+loadDialog.getFile();
		...
		String filename = graphFile.replace(".pop", "");
	...
	public Graph loadGraph() {
		...
		loadDialog.setVisible(true);
		graphFile = loadDialog.getDirectory()+loadDialog.getFile();
		if(graphFile.contains("null"))
			return null;
		...
		try
		{
			FileInputStream fin = new FileInputStream(graphFile);
